...
**Обратите внимение: при установке TARS-CLI необходимо использовать npm второй версии. Работа по корректной установке в npm 3 уже ведутся! В ближайшем релизе все будет исправлено!**
