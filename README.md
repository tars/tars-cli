...
**Attention: you have to use npm 2.x.x for TARS-CLI installing. We are working on installation process via npm 3.x.x and it will be fixed in the closest release!**
