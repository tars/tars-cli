...
var generalOptionsProcessing = require('./utils/general-options-processing');
var buildPromt = require('../promt/build-promt');
...
function buildInit(answers) {
    ...
    runCommand('./node_modules/.bin/gulp', buildOptions);
}
...
module.exports = function build(options) {
    ...
    if (!commandOptions.silent && !commandOptions.release && !commandOptions.min && !commandOptions.ie8 && !commandOptions.customFlags) {
        tarsUtils.tarsSay('Welcome to the interactive mode.');
        tarsUtils.tarsSay('Please, ask some questions:');
