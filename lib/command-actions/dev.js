...
const updateBabelConfig = require('./utils/update-babelrc');
let buildOptions = ['dev'];
let commandOptions;
...
module.exports = function dev(options) {
    ...
    if (
        !commandOptions.silent && !commandOptions.tunnel && !commandOptions.livereload &&
        !commandOptions.lr && !commandOptions.ie8 && !commandOptions.ie9 &&
        !commandOptions.ie && !commandOptions.customFlags
    ) {
